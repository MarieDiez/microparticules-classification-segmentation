...
class Ui_MainWindow(object):
    ...
    """FONCTION DE BASE"""
    def create_dir(self):
        if os.path.isdir(("{}/Multi".format(os.getcwd()))):
            shutil.rmtree("{}/Multi".format(os.getcwd()))
        if os.path.isdir("{}/Others".format(os.getcwd())):
            shutil.rmtree("{}/Others".format(os.getcwd()))
        if os.path.isdir(("{}/MixedImages/imgJpg".format(os.getcwd()))):
            shutil.rmtree("{}/MixedImages/imgJpg".format(os.getcwd()))
        if os.path.isdir(("{}/Multi/imgJpg".format(os.getcwd()))):
            shutil.rmtree("{}/Multi/imgJpg".format(os.getcwd()))
        if os.path.isdir(("{}/Multi/Segmented".format(os.getcwd()))):
            shutil.rmtree("{}/Multi/Segmented".format(os.getcwd()))
        os.mkdir("{}/Multi".format(os.getcwd()))
        os.mkdir("{}/Multi/Segmented".format(os.getcwd()))
        os.mkdir("{}/Others".format(os.getcwd()))
        if apercu:
            os.mkdir("{}/MixedImages/imgJpg".format(os.getcwd()))
            os.mkdir("{}/Multi/imgJpg".format(os.getcwd()))
    ...
    def readImages2(self):
        image_dir = os.path.join(os.getcwd(), 'Multi')
        return [f for f in os.listdir(image_dir) if os.path.isfile(os.path.join(image_dir, f))], image_dir

    """ CHECBOX """

    def classif_actionChange(self, state):
        global classif
    ...
    def blob_detectorThread(self, i, images, image_dir):
        ...
        # Cas spéciale : simple alongé
        ratioX_spe = 0.7
        ratioY_spe = 0.25
        if (ratioX >= ratioX_spe and ratioY <= ratioY_spe) or(ratioY >= ratioX_spe and ratioX <= ratioY_spe):
            blobs_log = blob_dog(image_gray, min_sigma=70,max_sigma=100, overlap=0.5, threshold=.5)
        elif ratioX >= ratioX_norm or ratioY >= ratioY_norm:
        ...
        if not seg and len(blobs_log) > 1:
            watershed_ok = True
        else:
            watershed_ok = self.watershed_ok_only(image, name)
        if dontmove == False:
            if (len(blobs_log) > 1 and hough_ok) or watershed_ok:
                self.watershed_global(image, name)
                shutil.copy(full_image_path, "{}/Multi".format(os.getcwd()))
            else:
                shutil.copy(full_image_path, "{}/Others".format(os.getcwd()))
        if apercu:
    ...
    def hough_detectorThread(self, i, images, image_dir):
        ...
        ratio_inter = self.doubleSpinBox_15.value()
        nb_circles = self.spinBox.value()
        ecart_max = self.spinBox_2.value()
        min_radius_grand = self.spinBox_17.value()
        max_radius_grand = self.spinBox_16.value()
        ...
        lenW, lenB = np.sum(np.where(edges == 255,1,0)) , np.sum(np.where(edges == 0,1,0))
        ratio = lenW / (lenW+lenB)
    ...
    def watershed_global(self, img, name):
        ...
        hough_radii = np.arange(25, 70, 2)
        hough_res = hough_circle(edges, hough_radii)
        accums, cx, cy, radii = hough_circle_peaks(hough_res, hough_radii, total_num_peaks=15)
            ...
            if seg:
                ...
                for label in unique_label:
                    if label != 0:
                        ...
                        plt.axis('off')
                        fig.savefig("Multi/Segmented/{}_{}.tif".format(name.split(".")[0], k), bbox_inches='tight', pad_inches=0)
                        k+=1
    ...
    def watershed_detector_segmentationThread(self, i, images, image_dir):
        global blob_on , hough_on, color_on, seg_on, seg_only_on
        blob_on = False
        hough_on = False
        color_on = False
        ...
        self.watershed_global(img, name)

    def watershed_ok_only(self, img, name):
        imgPath = "imgJpg/"+name.split(".")[0]+".jpg"
        pathApercu = os.path.join(image_dir, imgPath)
    ...
    def setupUi(self, MainWindow):
        ...
        self.doubleSpinBox_4.setProperty("value", 50.0)
        ...
        self.doubleSpinBox_9.setProperty("value", 0.25)
        ...
        self.label_8.setGeometry(QtCore.QRect(90, 80, 61, 17))
        ...
        self.label_9.setGeometry(QtCore.QRect(410, 80, 71, 17))
        ...
        self.doubleSpinBox_10.setProperty("value", 0.5)
        ...
        self.doubleSpinBox_13.setProperty("value", 0.25)
        ...
        self.doubleSpinBox_6.setProperty("value", 99.99)
        ...
        self.doubleSpinBox_7.setProperty("value", 15.0)
        ...
        self.label_27.setGeometry(QtCore.QRect(10, 30, 41, 17))
        self.label_27.setObjectName("label_27")
        self.doubleSpinBox_15 = QtWidgets.QDoubleSpinBox(self.tab)
        self.doubleSpinBox_15.setGeometry(QtCore.QRect(50, 30, 121, 26))
        self.doubleSpinBox_15.setSingleStep(0.1)
        self.doubleSpinBox_15.setProperty("value", 0.3)
        ...
        self.label_29.setGeometry(QtCore.QRect(360, 230, 81, 17))
        self.label_29.setObjectName("label_29")
        self.spinBox_16 = QtWidgets.QDoubleSpinBox(self.tab)
        self.spinBox_16.setGeometry(QtCore.QRect(470, 270, 131, 26))
        self.spinBox_16.setProperty("value", 60)
        self.spinBox_16.setObjectName("spinBox_16")
        self.label_30 = QtWidgets.QLabel(self.tab)
        self.label_30.setGeometry(QtCore.QRect(360, 280, 81, 17))
        self.label_30.setObjectName("label_30")
        self.spinBox_17 = QtWidgets.QDoubleSpinBox(self.tab)
        self.spinBox_17.setGeometry(QtCore.QRect(470, 230, 131, 26))
        self.spinBox_17.setProperty("value", 20)
        self.spinBox_17.setObjectName("spinBox_17")
        self.label_31 = QtWidgets.QLabel(self.tab)
        self.label_31.setGeometry(QtCore.QRect(410, 200, 81, 17))
        ...
        self.spinBox_5.setProperty("value", 70)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_8.setText(_translate("MainWindow", "Petit Blob"))
        ...
        self.label_9.setText(_translate("MainWindow", "Grand Blob"))
        ...
        self.label_28.setText(_translate("MainWindow", "Petit Cercle :"))
        self.label_29.setText(_translate("MainWindow", "min radius :"))
        self.label_30.setText(_translate("MainWindow", "max radius :"))
        self.label_31.setText(_translate("MainWindow", "Grand Cercle :"))
        ...
        self.label_34.setText(_translate("MainWindow", "max_size :"))
